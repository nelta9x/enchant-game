...
//   · 발동(armed): 룬이 흰빛으로 점등·회전하고, SwordStage 의 흰색 글로우가 검을 감싼다
...
export function ProtectionWard({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-visible">
      ...
      {/* 보호 결계 서클 — 검 좌상단(마력의 근원). 검의 회전 결계와 닿지 않게 바깥으로 띄운다. */}
    ...
    >
      ...
      <span className="absolute inset-0 grid place-items-center">
        {unavailable ? (
          ...
          <ItemIcon itemId={PROTECTION_TICKET_ID} className="h-8 w-8" />
        )}
      </span>
