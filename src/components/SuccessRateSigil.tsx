...
// 회전 마법진을 공유하고, 색도 일반 마법진과 동일하게 둔다 — 룬은 기본 마법진 색(ink-soft, 보호
...
//     두 결계의 색이 완전히 일치한다. 글자 크기는 rem(원 h-16 과 같은 단위)이라 반응형으로 원이 줄어도
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute inset-0 grid place-items-center text-[0.75rem] font-bold tabular-nums text-ink-soft">
          {text}
        </span>
      </div>
    </div>
