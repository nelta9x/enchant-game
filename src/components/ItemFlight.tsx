...
// 같은 분출 섬광 + 같은 비행 칩(FlightChip). 코인과 갈리는 점은 둘 — (1) 코인 다발 대신 아이콘 1장이
// 난다(아이템은 단일 객체라 칩 1개), (2) 회전을 끈다(아래 spin=false — 검·아이템이 공중제비 도는 게
// 어색해서. 코인만 빛 반사하듯 돈다). 그 외 위치·크기·투명도 곡선은 코인과 공유한다.
//
