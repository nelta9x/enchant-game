...
// 'itemFlight' 이벤트(재생 id + itemId)에만 반응한다 — 골드(코인) 비행과 같은 안무를 쓴다:
// 같은 분출 섬광(LaunchFlare) + 같은 비행 칩(FlightChip). 코인과 갈리는 점은 하나 — 코인 다발 대신
// 아이콘 1장이 난다(아이템은 단일 객체라 칩 1개). 위치·크기·투명도 곡선은 코인과 공유한다(둘 다 회전 없음).
//
